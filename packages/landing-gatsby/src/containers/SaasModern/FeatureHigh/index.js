...
import ProcessItem, { ProcessIndex } from './featureHigh.style';

const FeatureHighSection = ({
  sectionWrapper,
  secTitleWrapper,
  secText,
  secHeading,
    ...
    <Box {...sectionWrapper} as="section">
      <Container>
        {/* <Box {...secTitleWrapper}>
          ...
          <Heading
            {...secHeading}
            content="3 Reasons Why this is the future of Shopping"
          />
        </Box> */}

        <Box {...processRow}>
          {Data.saasModernJson.FEATURE_HIGH.map((item, index) => (
            <Box
              {...processCol}
...
export default FeatureHighSection;
