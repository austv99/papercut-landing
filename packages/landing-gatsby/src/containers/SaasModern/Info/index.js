      ...
      <Container>
        <Box {...row} {...textAreaRow}>
          <Box {...col} {...textArea}>
            <Heading
              {...title}
              content="Simply Organised. Simply Green."
            />
            <Text
              {...description}
              content="All your receipts will be sorted based on a number of factors. No more looking through stacks of paper for the right one."
            />
            <Box>
              <a href="#1">
